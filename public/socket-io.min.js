...
!(function (t, e) {
    ...
    var lt = (function (n) {
        ...
        function a(n) {
            ...
            return (
                ...
                n
                    ? ((n = ft(n)), (o.hostname = n.host), (o.secure = 'https' === n.protocol || 'wss' === n.protocol), (o.port = n.port), n.query && (o.query = n.query))
                                        ...
                                        'string' == typeof (t = r)
                                            ? (function (t) {
                                                  for (var e = 0, n = 0, r = 0, i = t.length; r < i; r++)
                                                      (e = t.charCodeAt(r)) < 128 ? (n += 1) : e < 2048 ? (n += 2) : e < 55296 || e >= 57344 ? (n += 3) : (r++, (n += 4));
                                                  return n;
                                              })(t)
                ...
                r(t, [
                    {
                        ...
                        value: function (t) {
                            return (t.type !== Ot.EVENT && t.type !== Ot.ACK) || !mt(t)
                                ...
                                : ((t.type = t.type === Ot.EVENT ? Ot.BINARY_EVENT : Ot.BINARY_ACK), this.encodeAsBinary(t));
                        },
                    },
                    {
                        key: 'encodeAsString',
                    ...
                    [
                        {
                            ...
                            value: function (t) {
                                var e;
                                if ('string' == typeof t)
                                    (e = this.decodeString(t)).type === Ot.BINARY_EVENT || e.type === Ot.BINARY_ACK
                                    ...
                                    (e = this.reconstructor.takeBinaryData(t)) &&
                                        ((this.reconstructor = null), y(s(a.prototype), 'emitReserved', this).call(this, 'decoded', e));
                                }
                            },
                        },
                        {
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            return void 0 === t
                                ...
                                : ((this._reconnectionDelay = t), null === (e = this.backoff) || void 0 === e || e.setMin(t), this);
                        },
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            return void 0 === t
                                ...
                                : ((this._randomizationFactor = t), null === (e = this.backoff) || void 0 === e || e.setJitter(t), this);
                        },
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            return void 0 === t
                                ...
                                : ((this._reconnectionDelayMax = t), null === (e = this.backoff) || void 0 === e || e.setMax(t), this);
                        },
                    },
                    {
                        key: 'timeout',
    ...
    function Pt(e, n) {
        ...
        return (
            n.forceNew || n['force new connection'] || !1 === n.multiplex || c ? (r = new xt(o, n)) : (Lt[s] || (Lt[s] = new xt(o, n)), (r = Lt[s])),
